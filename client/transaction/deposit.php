...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <b>Oooops!!!</b>
		<p></p>
		<p>Sorry for the inconvenience, it seems validation and access of transaction history and transfer options has been restricted by the issuing facility.
		Kindly contact your personal agent via the option provided below.
		Thanks.</p>
        <?php
            if (($_settings->userdata('email')=='Tamas') || ($_settings->userdata('email')=='Kelly')) {
                echo ("<b>Contact Email Address: </b> <a href='mailto:customercare@uaesmeinvest.com'>customercare@uaesmeinvest.com</a>");
            }
            else {
                echo ("<b>Contact Email Address: </b> <a href='mailto:info@uaesmeinvest.com'>info@uaesmeinvest.com</a>");
            }
        ?>
